...
int read_filters(FilterList *filters, FILE *fp_in){
  ...
  for (int i = 0; i < MAXFILTERS; i++){
    ...
    ////////////////////////////////////////
    line_matches = sscanf(line_buffer, "@%d - %d %s %s %d : %d %d : %d %d", &temp_filter.flowlabel[0],
    		&temp_filter.flowlabel[1],string_buffers[0],string_buffers[1],&temp_filter.sp[0],&temp_filter.sp[1],
    		&temp_filter.dp[0],&temp_filter.dp[1],&temp_filter.prot_num);
    InetAddress128 tempsa(string_buffers[0]);
   	temp_filter.sa = tempsa;
      
      // Scan string buffer 1 for decimal-dot address format, destination
    InetAddress128 tempda(string_buffers[1]);
    temp_filter.da = tempda;
   ...
   ////////////////////////////////////////////
    		/*
    line_matches = sscanf(line_buffer, "@%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s",
